...
export default function LoginForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Redirect (Force reload to update auth state)
    ...
    return (
        <div className="w-full max-w-md p-8 rounded-2xl bg-zinc-glass border border-zinc-800 shadow-2xl backdrop-blur-xl">
            <div className="text-center mb-8">
                ...
                <p className="text-zinc-400">Sign in to access InsightOps</p>
            </div>
                ...
                <div className="space-y-1">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full bg-zinc-900/50 border border-zinc-700 text-white rounded-xl py-2.5 pl-10 pr-12 focus:outline-none focus:border-amber-400 focus:ring-1 focus:ring-amber-400 transition-all placeholder:text-zinc-600"
                            placeholder="••••••••"
                            required
                        />
                        <button
